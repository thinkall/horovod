...
baseline="test-cpu-gloo-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0"
...
tests=$(if [[ -n "${PIPELINE_MODE:-}" ]] && ( [[ "${BUILDKITE_BRANCH:-}" == "${BUILDKITE_PIPELINE_DEFAULT_BRANCH:-}" ]] || [[ -n "$code_files" ]] ); then
  ...
  printf "test-cpu-gloo-py3_7-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark2_4_8 "
  printf "test-cpu-gloo-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_1_2 "
  # our baseline
  printf "$baseline "

  # then we vary the baseline along mpi kinds dimension
  # our baseline again
# printf "test-cpu-gloo-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0 "
  printf "test-cpu-mpich-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0 "
  printf "test-cpu-oneccl-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0 "
  printf "test-cpu-openmpi-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0 "
  # note: we test openmpi-gloo mpi kind in this variation in each of [cpu, gpu, mixed]
  printf "test-cpu-openmpi-gloo-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0 "
  ...
  #printf "test-cpu-gloo-py3_8-tf2_5_1-keras2_5_1-torch1_8_1-mxnet1_6_0_p0-pyspark3_2_0 "
  printf "test-cpu-gloo-py3_8-tf2_6_0-keras2_6_0-torch1_9_1-mxnet1_7_0_p2-pyspark3_2_0 "
  # our baseline again
# printf "test-cpu-gloo-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0 "
  ...
  printf "test-gpu-gloo-py3_8-tf2_5_1-keras2_5_1-torch1_8_1-mxnet1_6_0_p0-pyspark3_2_0 "
  ...
  printf "test-gpu-gloo-py3_8-tf2_5_1-keras2_5_1-torch1_8_1-mxnet1_7_0_p1-pyspark3_2_0 "
  ...
  printf "test-gpu-gloo-py3_8-tf2_6_0-keras2_6_0-torch1_9_1-mxnet1_8_0_p0-pyspark3_2_0 "
  printf "test-gpu-openmpi-gloo-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0 "
  printf "test-gpu-gloo-py3_8-tfhead-keras_none-torchhead-mxnethead-pyspark3_2_0 "

  # and one final test with mixed cpu+gpu
  printf "test-mixed-openmpi-gloo-py3_8-tf2_7_0-keras2_7_0-torch1_10_0-mxnet1_8_0_p0-pyspark3_2_0 "
...
run_gloo_integration() {
  ...
  if [[ ${test} == ${baseline} ]] || [[ ${test} == test-cpu-gloo-*-tf1_* ]] || [[ ${test} != *pyspark3_2_0* ]]; then
    run_test "${test}" "${queue}" \
  ...
  if [[ ${test} == ${baseline} ]] || [[ ${test} != *pyspark3_2_0* ]]; then
    run_test "${test}" "${queue}" \
